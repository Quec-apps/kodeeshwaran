...
a++;
window["a-e-q-ma"+a] = "ഇന്ത്യയുടെ കേന്ദ്രഭരണ പ്രദേശമായ ലക്ഷദ്വീപിന്റെ ഭാഷയാണ്";
window["a-e-q-en"+a] = "The language of Lakshadweep, a Union Territory of India, is";
window["a-e-A"+a] = "Tamil";
window["a-e-B"+a] = "Hindi";
window["a-e-C"+a] = "Malayalam";
window["a-e-D"+a] = "Telugu";
window["a-e-ans"+a] = 3;

a++;
window["a-e-q-ma"+a] = "ചെക്ക്മേറ്റ് ഉള്ള ഗെയിം ഏതാണ്?";
window["a-e-q-en"+a] = "Which game has checkmate?";
window["a-e-A"+a] = "Monopoly";
window["a-e-B"+a] = "Billiard";
window["a-e-C"+a] = "Chess";
window["a-e-D"+a] = "Tic tac toe";
window["a-e-ans"+a] = 3;

a++;
window["a-e-q-ma"+a] = "ഒരു സംഗീത സ്കെയിലിൽ എത്ര സ്വരഗുണം ഉണ്ട്?";
window["a-e-q-en"+a] = "How many notes are there in a musical scale?";
window["a-e-A"+a] = "8";
window["a-e-B"+a] = "7";
window["a-e-C"+a] = "10";
window["a-e-D"+a] = "9";
...
a++;
window["a-e-q-ma"+a] = "Tic-Tac-Toe- ന്റെ ഒരു സ്റ്റാൻഡേർഡ് ഗെയിമിൽ, തുടർച്ചയായി വിജയിക്കാൻ നിങ്ങൾക്ക് എത്ര X- കൾ അല്ലെങ്കിൽ O- കൾ ആവശ്യമാണ്?";
window["a-e-q-en"+a] = "In a standard game of Tic-Tac-Toe, how many X's or O's do you need in a row to win?";
window["a-e-A"+a] = "5";
window["a-e-B"+a] = "3";
window["a-e-C"+a] = "2";
window["a-e-D"+a] = "4";
...
a++;
window["a-e-q-ma"+a] = "ഏത് നക്ഷത്രം പകൽ പ്രകാശിക്കുകയും പ്രകാശം നൽകുകയും ചെയ്യുന്നു?";
window["a-e-q-en"+a] = "What star shines in the day and provides light?";
window["a-e-A"+a] = "Moon";
window["a-e-B"+a] = "Brad Pitt";
window["a-e-C"+a] = "Sirius";
window["a-e-D"+a] = "Sun";
window["a-e-ans"+a] = 4;

a++;
window["a-e-q-ma"+a] = "ഇനിപ്പറയുന്നവയിൽ പശുക്കൾ എന്താണ് കഴിക്കുന്നത്?";
window["a-e-q-en"+a] = "What of the following do cows eat?";
window["a-e-A"+a] = "Grass";
window["a-e-B"+a] = "Milk";
window["a-e-C"+a] = "Foxes";
window["a-e-D"+a] = "Butterflies";
window["a-e-ans"+a] = 1;

a++;
window["a-e-q-ma"+a] = "വാൾട്ട് ഡിസ്നി കമ്പനിയുടെ പ്രതീകമായി മാറിയ കാർട്ടൂൺ കഥാപാത്രം ഏതാണ്?";
window["a-e-q-en"+a] = "Which cartoon character has become a symbol for the Walt Disney Company?";
window["a-e-A"+a] = "Mickey Mouse";
window["a-e-B"+a] = "Winnie the Pooh";
window["a-e-C"+a] = "Donald Duck";
window["a-e-D"+a] = "Bugs Bunny";
window["a-e-ans"+a] = 1;

a++;
window["a-e-q-ma"+a] = "ശരീരത്തിലോ മനസ്സിലോ തളർന്നിരിക്കുന്ന അവസ്ഥയെ നിങ്ങൾ എന്താണ് വിളിക്കുന്നത്?";
window["a-e-q-en"+a] = "What do you call the condition of being tired in body or mind?";
window["a-e-A"+a] = "Fatigue";
window["a-e-B"+a] = "Intrigue";
window["a-e-C"+a] = "Youth";
window["a-e-D"+a] = "Freshness";
window["a-e-ans"+a] = 1;

a++;
window["a-e-q-ma"+a] = "മനുഷ്യ ശരീരത്തിലെ ഏറ്റവും വലിയ അവയവം ഏതാണ്?";
window["a-e-q-en"+a] = "What is the largest organ of the human body?";
window["a-e-A"+a] = "Skin";
window["a-e-B"+a] = "Brain";
window["a-e-C"+a] = "Liver";
window["a-e-D"+a] = "Heart";
window["a-e-ans"+a] = 1;

a++;
window["a-e-q-ma"+a] = "എന്താണ് സൈലോഫോൺ?";
window["a-e-q-en"+a] = "What's a xylophone?";
window["a-e-A"+a] = "Measures seismic waves";
window["a-e-B"+a] = "Musical instrument";
window["a-e-C"+a] = "A stereo telephone";
window["a-e-D"+a] = "A medical device";
window["a-e-ans"+a] = 2;

a++;
window["a-e-q-ma"+a] = "ഏത് ചെസ്സ് കഥാപാത്രത്തിന് ഒരു നേർരേഖയിൽ നീങ്ങാൻ കഴിയില്ല?";
window["a-e-q-en"+a] = "Which chess piece can't move in a straight line?";
window["a-e-A"+a] = "Rook";
window["a-e-B"+a] = "Knight";
window["a-e-C"+a] = "King";
window["a-e-D"+a] = "Bishop";
window["a-e-ans"+a] = 2;

a++;
window["a-e-q-ma"+a] = "എഫ്എം ബ്രോഡ്കാസ്റ്റിംഗിലെ വിവരങ്ങൾ എൻകോഡ് ചെയ്യാൻ തരംഗങ്ങളുടെ എന്ത് സ്വത്താണ് ഉപയോഗിക്കുന്നത്?";
window["a-e-q-en"+a] = "What property of waves is used to encode the information in FM broadcasting?";
window["a-e-A"+a] = "Polarization";
window["a-e-B"+a] = "Difffraction";
window["a-e-C"+a] = "Frequency";
window["a-e-D"+a] = "Amplitude";
window["a-e-ans"+a] = 3;

a++;
window["a-e-q-ma"+a] = "ഈ പാമ്പുകളിൽ ഏതാണ് വിഷമില്ലാത്തത്?";
window["a-e-q-en"+a] = "Which of these snakes is not venomous?";
window["a-e-A"+a] = "Mamba";
window["a-e-B"+a] = "Cobra";
window["a-e-C"+a] = "Rattlesnake";
window["a-e-D"+a] = "Anaconda";
window["a-e-ans"+a] = 4;

a++;
window["a-e-q-ma"+a] = "കുറിപ്പടിയിൽ മാത്രം ലഭ്യമാകുന്ന മരുന്ന് ഏതാണ്?";
window["a-e-q-en"+a] = "Which drug typically only available with a prescription?";
window["a-e-A"+a] = "Vitamin C";
window["a-e-B"+a] = "Aspirin";
window["a-e-C"+a] = "Petroleum jelly";
window["a-e-D"+a] = "Warfarin";
window["a-e-ans"+a] = 4;

a++;
window["a-e-q-ma"+a] = "വെള്ളത്തിനടിയിൽ ഒരു അന്തർവാഹിനിയിൽ നിന്ന് ജലത്തിന്റെ ഉപരിതലത്തിൽ വസ്തുക്കൾ കാണുന്നതിന്, ഉപയോഗിക്കുന്ന ഉപകരണത്തെ എന്താണ് വിളിക്കുന്നത്?";
window["a-e-q-en"+a] = "For seeing objects at the surface of water from a submarine under water, the instrument used is";
window["a-e-A"+a] = "kaleidoscope";
window["a-e-B"+a] = "periscope";
window["a-e-C"+a] = "spectroscope";
window["a-e-D"+a] = "telescope";
window["a-e-ans"+a] = 2;

a++;
window["a-e-q-ma"+a] = "ഒരു ഡസനിൽ എത്ര മുട്ടകളുണ്ട്?";
window["a-e-q-en"+a] = "How many eggs are there in a dozen?";
window["a-e-A"+a] = "10";
window["a-e-B"+a] = "12";
window["a-e-C"+a] = "9";
window["a-e-D"+a] = "11";
...
a++;
window["a-e-q-ma"+a] = "മേഘങ്ങളിൽ നിന്ന് വീഴുന്ന വെള്ളത്തിന്റെ സവിശേഷത ഏത് തരം ജലപാതമാണ്?";
window["a-e-q-en"+a] = "What kind of precipitation is characterised by falling water from the clouds?";
window["a-e-A"+a] = "Hail";
window["a-e-B"+a] = "Wind";
window["a-e-C"+a] = "Rain";
window["a-e-D"+a] = "Rockfall";
window["a-e-ans"+a] = 3;

a++;
window["a-e-q-ma"+a] = "ഒരു വിരലിൽ ഏത് ആഭരണമാണ് ധരിക്കുന്നത്?";
window["a-e-q-en"+a] = "What piece of jewelry is worn on a finger?";
window["a-e-A"+a] = "Necklace";
window["a-e-B"+a] = "Belt";
window["a-e-C"+a] = "Ring";
window["a-e-D"+a] = "Watch";
window["a-e-ans"+a] = 3;

a++;
window["a-e-q-ma"+a] = "'മുതലായവ' എന്നതിന്റെ ചുരുക്കെഴുത്ത് ഏതാണ്?";
window["a-e-q-en"+a] = "Which is the abbreviation for 'etcetera'?";
window["a-e-A"+a] = "etr";
window["a-e-B"+a] = "ect";
window["a-e-C"+a] = "etc";
window["a-e-D"+a] = "est";
...
a++;
window["a-e-q-ma"+a] = "ഏറ്റവും കഠിനമായ മെറ്റീരിയൽ ഏതാണ്?";
window["a-e-q-en"+a] = "What is the hardest material?";
window["a-e-A"+a] = "Cobalt";
window["a-e-B"+a] = "Marble";
window["a-e-C"+a] = "Diamond";
window["a-e-D"+a] = "Steel";
window["a-e-ans"+a] = 3;

a++;
window["a-e-q-ma"+a] = "എന്തിനുവേണ്ടിയാണ് ഒരു MP3 ഉപയോഗിക്കുന്നത്?";
window["a-e-q-en"+a] = "An MP3 is used for what?";
window["a-e-A"+a] = "Cleaning clothes";
window["a-e-B"+a] = "Music compression";
window["a-e-C"+a] = "Video recording";
window["a-e-D"+a] = "Document storage";
window["a-e-ans"+a] = 2;

a++;
window["a-e-q-ma"+a] = "ഒരു പൂച്ചെണ്ടിൽ എന്താണ് അടങ്ങിയിരിക്കുന്നത്?";
window["a-e-q-en"+a] = "What does a bouquet contain a bunch of?";
window["a-e-A"+a] = "Flowers";
window["a-e-B"+a] = "Fruit";
window["a-e-C"+a] = "Plastic straws";
window["a-e-D"+a] = "Candy";
window["a-e-ans"+a] = 1;

a++;
window["a-e-q-ma"+a] = "ശാസ്ത്ര വ്യവസായത്തിൽ പ്രവർത്തിക്കുന്ന ഒരു വ്യക്തിയെ നിങ്ങൾ എന്താണ് വിളിക്കുന്നത്? അവർ ധാരാളം പരീക്ഷണങ്ങൾ നടത്തുന്നു.";
window["a-e-q-en"+a] = "What do you call a person that works in the science industry? They do many experiments.";
window["a-e-A"+a] = "Secretary";
window["a-e-B"+a] = "Florist";
window["a-e-C"+a] = "Scientist";
window["a-e-D"+a] = "Fortune-teller";
window["a-e-ans"+a] = 3;

a++;
window["a-e-q-ma"+a] = "ഇരുമ്പ് കൊണ്ട് നിർമ്മിച്ച വസ്തുക്കൾ തന്നിലേക്ക് വലിച്ചെടുക്കാൻ കഴിവുള്ള ഒരു വസ്തുവിനെ നിങ്ങൾ എന്താണ് വിളിക്കുന്നത്?";
window["a-e-q-en"+a] = "What do you call an object that has the power to pull items made of iron toward itself?";
window["a-e-A"+a] = "Money";
window["a-e-B"+a] = "Magnate";
window["a-e-C"+a] = "Magnet";
window["a-e-D"+a] = "Agate";
window["a-e-ans"+a] = 3;

a++;
window["a-e-q-ma"+a] = "റോമൻ അക്കങ്ങളിൽ 'XIX' ഏത് സംഖ്യയെ പ്രതിനിധീകരിക്കുന്നു?";
window["a-e-q-en"+a] = "What number is represented by 'XIX' in Roman numericals?";
window["a-e-A"+a] = "11";
window["a-e-B"+a] = "19";
window["a-e-C"+a] = "21";
window["a-e-D"+a] = "101";
...
a++;
window["a-e-q-ma"+a] = "എയ്ഡ്സിന്റെ കാരണം എന്താണ്?";
window["a-e-q-en"+a] = "What is the cause of AIDS?";
window["a-e-A"+a] = "Pox virus";
window["a-e-B"+a] = "NPV";
window["a-e-C"+a] = "HIV";
window["a-e-D"+a] = "Ebola virus";
window["a-e-ans"+a] = 3;

a++;
window["a-e-q-ma"+a] = "ഒരു മരത്തിന്റെ പുറം പാളി എന്താണ്?";
window["a-e-q-en"+a] = "What is the outer layer of the trunk of a tree?";
window["a-e-A"+a] = "Growth ring";
window["a-e-B"+a] = "Sapwoood";
window["a-e-C"+a] = "Pith";
window["a-e-D"+a] = "Bark";
window["a-e-ans"+a] = 4;

a++;
window["a-e-q-ma"+a] = "ദ്രാവകത്തിൽ നിന്ന് ഖര ഘട്ടത്തിലേക്കുള്ള പരിവർത്തനം എന്താണ്?";
window["a-e-q-en"+a] = "What is the transformation from liquid to solid phase?";
window["a-e-A"+a] = "Condensation";
window["a-e-B"+a] = "Freezing";
window["a-e-C"+a] = "Boiling";
window["a-e-D"+a] = "Melting";
window["a-e-ans"+a] = 2;

a++;
window["a-e-q-ma"+a] = "മനുഷ്യർ ...?";
window["a-e-q-en"+a] = "Humans are...?";
window["a-e-A"+a] = "Fossorial";
window["a-e-B"+a] = "holometabolic";
window["a-e-C"+a] = "Monocular";
window["a-e-D"+a] = "Omnivorous";
window["a-e-ans"+a] = 4;

a++;
window["a-e-q-ma"+a] = "ആരാണ് ഒരു ആശുപത്രിയിൽ ജോലി ചെയ്യാൻ കൂടുതൽ സാധ്യതയുള്ളത്?";
window["a-e-q-en"+a] = "Who is most likely to work in a hospital?";
window["a-e-A"+a] = "Embroiderer";
window["a-e-B"+a] = "Surgeon";
window["a-e-C"+a] = "Smith";
window["a-e-D"+a] = "Carpenter";
window["a-e-ans"+a] = 2;

a++;
window["a-e-q-ma"+a] = "ഉറക്കത്തിൽ ഏത് അവയവം പ്രവർത്തനം നിർത്തുന്നു?";
window["a-e-q-en"+a] = "Which organ stops operating during sleep?";
window["a-e-A"+a] = "None of these";
window["a-e-B"+a] = "Heart";
window["a-e-C"+a] = "Liver";
window["a-e-D"+a] = "Kidney";
window["a-e-ans"+a] = 1;

a++;
window["a-e-q-ma"+a] = "ഐസ് വെള്ളത്തിൽ എന്താണ് ചെയ്യുന്നത്?";
window["a-e-q-en"+a] = "What does ice do in water?";
window["a-e-A"+a] = "It evaporates";
window["a-e-B"+a] = "It floats";
window["a-e-C"+a] = "It sinks";
window["a-e-D"+a] = "It become black";
window["a-e-ans"+a] = 2;

a++;
window["a-e-q-ma"+a] = "ഏത് ഗ്രഹത്തിന്റെ ഉപരിതലത്തിന്റെ 70% വെള്ളത്താൽ മൂടപ്പെട്ടിരിക്കുന്നു?";
window["a-e-q-en"+a] = "70% of which planet's surface is covered with water?";
window["a-e-A"+a] = "Mars";
window["a-e-B"+a] = "Mercury";
window["a-e-C"+a] = "Earth";
window["a-e-D"+a] = "Venus";
window["a-e-ans"+a] = 3;

a++;
window["a-e-q-ma"+a] = "ഗണിതത്തിന്റെ ഏത് ശാഖയാണ് കൂട്ടിച്ചേർക്കൽ, കുറയ്ക്കൽ, വിഭജനം, ഗുണനം എന്നിവയിൽ ശ്രദ്ധ കേന്ദ്രീകരിക്കുന്നത്?";
window["a-e-q-en"+a] = "What branch of mathematics focuses on addition, subtraction, division and multiplication?";
window["a-e-A"+a] = "Geometry";
window["a-e-B"+a] = "Statistics";
window["a-e-C"+a] = "Analysis";
window["a-e-D"+a] = "Arithmetic";
window["a-e-ans"+a] = 4;

a++;
window["a-e-q-ma"+a] = "വ്യക്തിഗത തിരിച്ചറിയലിനായി ഏത് സെൽ ഘടകമാണ് പലപ്പോഴും ഉപയോഗിക്കുന്നത്?";
window["a-e-q-en"+a] = "What cell component is often used for personal identification?";
window["a-e-A"+a] = "Membrane";
window["a-e-B"+a] = "DNA";
window["a-e-C"+a] = "Cytoplasm";
window["a-e-D"+a] = "Golgi";
window["a-e-ans"+a] = 2;

a++;
window["a-e-q-ma"+a] = "വളവുകളോ വരകളോ അരികുകളോ കൂടിച്ചേരുന്ന ഒരു പോയിന്റ് എന്താണ്?";
window["a-e-q-en"+a] = "What is a point where curves, lines or edges meet?";
window["a-e-A"+a] = "Torus";
window["a-e-B"+a] = "Voxel";
window["a-e-C"+a] = "Surd";
window["a-e-D"+a] = "Vertex";
window["a-e-ans"+a] = 4;

a++;
window["a-e-q-ma"+a] = "ഗർഭിണികൾ സാധാരണയായി ചെയ്യാറില്ല?";
window["a-e-q-en"+a] = "Pregnant women normally do not ...?";
window["a-e-A"+a] = "Menstruate";
window["a-e-B"+a] = "Perspire";
window["a-e-C"+a] = "Urinate";
window["a-e-D"+a] = "Flatulate";
window["a-e-ans"+a] = 1;

a++;
window["a-e-q-ma"+a] = "ഏത് അവയവം നീക്കംചെയ്യുന്നത് വലിയ സങ്കീർണതകൾ ഇല്ലാതെ മനുഷ്യർ നിലനിൽക്കുന്നു?";
window["a-e-q-en"+a] = "The removal of which organ do humans survive without great complications?";
window["a-e-A"+a] = "Gallbladder";
window["a-e-B"+a] = "Heart";
window["a-e-C"+a] = "Cerebellum";
window["a-e-D"+a] = "Liver";
window["a-e-ans"+a] = 1;

a++;
window["a-e-q-ma"+a] = "അന്താരാഷ്ട്ര വനിതാ ദിനം എപ്പോഴാണ്?";
window["a-e-q-en"+a] = "When is International Women's Day?";
window["a-e-A"+a] = "January 12";
window["a-e-B"+a] = "March 8";
window["a-e-C"+a] = "August 23";
window["a-e-D"+a] = "December 5";
window["a-e-ans"+a] = 2;

a++;
window["a-e-q-ma"+a] = "ഇനിപ്പറയുന്നവയിൽ ഏതാണ് ആദ്യ കണക്കുകൂട്ടുന്ന ഉപകരണം?";
window["a-e-q-en"+a] = "Which of the following is the first calculating device?";
window["a-e-A"+a] = "Abacus";
window["a-e-B"+a] = "Calculator";
window["a-e-C"+a] = "Turing Machine";
window["a-e-D"+a] = "Pascaline";
window["a-e-ans"+a] = 1;

a++;
window["a-e-q-ma"+a] = "സ്ത്രീകളുടെ ഗർഭനിരോധന മാർഗ്ഗം ഏതാണ്?";
window["a-e-q-en"+a] = "Which is a female contraceptive?";
window["a-e-A"+a] = "Diaphragm ";
window["a-e-B"+a] = "Aciculum";
window["a-e-C"+a] = "Didymium";
window["a-e-D"+a] = "Frenulum";
window["a-e-ans"+a] = 1;

a++;
window["a-e-q-ma"+a] = "കുഞ്ഞുങ്ങളെ പോറ്റാൻ പാൽ ഉത്പാദിപ്പിക്കുന്ന അവയവം ഏതാണ്?";
window["a-e-q-en"+a] = "Which organ produces milk to feed young offspring?";
window["a-e-A"+a] = "Prostate";
window["a-e-B"+a] = "Pancreas";
window["a-e-C"+a] = "Pituitary gland";
window["a-e-D"+a] = "Mammary gland";
window["a-e-ans"+a] = 4;

a++;
window["a-e-q-ma"+a] = "ഹാൻഡ് മിക്‌സറിന്റെ അതേ പ്രവർത്തനം നിർവഹിക്കുന്ന അടുക്കള പാത്രം ഏതാണ്?";
window["a-e-q-en"+a] = "Which kitchen utensil performs the same function as a hand mixer?";
window["a-e-A"+a] = "Grater";
window["a-e-B"+a] = "Meat grinder";
window["a-e-C"+a] = "Whisk ";
window["a-e-D"+a] = "Ladle";
window["a-e-ans"+a] = 3;

a++;
window["a-e-q-ma"+a] = "ആദ്യത്തെ ഇഷ്ടികകൾ എന്തിൽ നിന്നാണ് നിർമ്മിച്ചത്?";
window["a-e-q-en"+a] = "The first bricks were made of what?";
window["a-e-A"+a] = "Gypsum";
window["a-e-B"+a] = "Clay";
window["a-e-C"+a] = "Humud";
window["a-e-D"+a] = "Talc";
window["a-e-ans"+a] = 2;

a++;
window["a-e-q-ma"+a] = "ഈ പതാകകളിൽ ഏറ്റവും കുറവ് നിറങ്ങൾ അടങ്ങിയിരിക്കുന്നത് ഏതാണ്?";
window["a-e-q-en"+a] = "Which of these flags contain the least number of colors?";
window["a-e-A"+a] = "India";
window["a-e-B"+a] = "United Kingdom";
window["a-e-C"+a] = "Canada";
window["a-e-D"+a] = "Syria";
window["a-e-ans"+a] = 3;

a++;
window["a-e-q-ma"+a] = "വളമായി അല്ലെങ്കിൽ മണ്ണ് കണ്ടീഷണറായി ഉപയോഗിക്കുന്നത് അഴുകിയ ജൈവവസ്തുക്കൾ ഏതാണ്?";
window["a-e-q-en"+a] = "What decayed organic material is used as fertilizer or soil conditioner?";
window["a-e-A"+a] = "Compost";
window["a-e-B"+a] = "Brine";
window["a-e-C"+a] = "Sediment";
window["a-e-D"+a] = "Vermin";
window["a-e-ans"+a] = 1;

a++;
window["a-e-q-ma"+a] = "8 ആപ്പിളിന്റെ വില $3 ആണ്. 24 ആപ്പിളിന്റെ വില എത്രയാണ്?";
window["a-e-q-en"+a] = "8 apples cost $3. How much do 24 apples cost?";
window["a-e-A"+a] = "$9";
window["a-e-B"+a] = "$8";
window["a-e-C"+a] = "$12";
window["a-e-D"+a] = "$6";
...
a++;
window["a-e-q-ma"+a] = "പ്രേക്ഷകർക്ക് മുന്നിൽ അഭിനയിക്കുന്ന ഒരു എഴുതിയ കഥ എന്താണ്?";
window["a-e-q-en"+a] = "What is a written story that is acted out in front of an audience?";
window["a-e-A"+a] = "Pastel";
window["a-e-B"+a] = "Novel";
window["a-e-C"+a] = "Drama";
window["a-e-D"+a] = "Sonnet";
window["a-e-ans"+a] = 3;

a++;
window["a-e-q-ma"+a] = "ഭൂരിപക്ഷം ആളുകൾക്കും അവരുടെ വ്യക്തിഗത വരുമാനത്തിന്റെ ഏറ്റവും വലിയ ഭാഗം വരുന്നത്?";
window["a-e-q-en"+a] = "For the majority of people, the largest portion of their personal income comes from?";
window["a-e-A"+a] = "Revenue and bonuses";
window["a-e-B"+a] = "Wages and salaries";
window["a-e-C"+a] = "Stocks and bonds";
window["a-e-D"+a] = "Rental and insurance";
window["a-e-ans"+a] = 2;

a++;
window["a-e-q-ma"+a] = "ഒരു റഗ്ബി പന്തിന്റെ ആകൃതി എന്താണ്?";
window["a-e-q-en"+a] = "What is the shape of a rugby ball?";
window["a-e-A"+a] = "Octahedron";
window["a-e-B"+a] = "Ellipsoid";
window["a-e-C"+a] = "Solid torus";
window["a-e-D"+a] = "Cylinder";
window["a-e-ans"+a] = 2;

a++;
window["a-e-q-ma"+a] = "ആൺകഴുതയുടെയും പെൺകുതിരയുടെയും സന്തതി എന്താണ്?";
window["a-e-q-en"+a] = "What is the offspring of a male donkey and female horse?";
window["a-e-A"+a] = "Steer";
window["a-e-B"+a] = "Mule";
window["a-e-C"+a] = "Hinny";
window["a-e-D"+a] = "Stallion";
window["a-e-ans"+a] = 2;

a++;
window["a-e-q-ma"+a] = "റെറ്റിനയിൽ നിന്ന് തലച്ചോറിലേക്ക് വിവരങ്ങൾ കൈമാറുന്നത് ഏത് നാഡിയാണ്?";
window["a-e-q-en"+a] = "What nerve transmits information from the retina to the brain?";
window["a-e-A"+a] = "Hypoglossal nerve";
window["a-e-B"+a] = "Facial nerve";
window["a-e-C"+a] = "Optic nerve";
window["a-e-D"+a] = "Abducens nerve";
window["a-e-ans"+a] = 3;

a++;
window["a-e-q-ma"+a] = "1 നും 10 നും ഇടയിൽ എത്ര prime numbers നിലവിലുണ്ട്?";
window["a-e-q-en"+a] = "How many prime numbers exist between 1 and 10?";
window["a-e-A"+a] = "7";
window["a-e-B"+a] = "5";
window["a-e-C"+a] = "6";
window["a-e-D"+a] = "4";
...
a++;
window["a-e-q-ma"+a] = "ഈ രാജ്യങ്ങളിൽ ഏതാണ് ഏറ്റവും ജനസംഖ്യയുള്ളത്?";
window["a-e-q-en"+a] = "Which of these countries is the most populous?";
window["a-e-A"+a] = "USA";
window["a-e-B"+a] = "Indonesia";
window["a-e-C"+a] = "Russia";
window["a-e-D"+a] = "India";
window["a-e-ans"+a] = 4;

a++;
window["a-e-q-ma"+a] = "പൂജ്യം dimension ഉള്ളത് ഏതാണ്?";
window["a-e-q-en"+a] = "Which has zero dimensions?";
window["a-e-A"+a] = "Sphere";
window["a-e-B"+a] = "Point";
window["a-e-C"+a] = "Line";
window["a-e-D"+a] = "Rectangle";
window["a-e-ans"+a] = 2;
